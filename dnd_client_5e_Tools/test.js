{'casting time': '1 minute',
 ...
 'description': 'This spell creates an undead servant. Choose a pile of bones '
                ...
                'it as an undead creature. The target becomes a skeleton if '
                'you chose bones or a zombie if you chose a corpse (the DM has '
                "the creature's game statistics). On each of your turns, you "
                'can use a bonus action to mentally command any creature you '
                'made with this spell if the creature is within 60 feet of you '
                '(if you control multiple creatures, you can command any or '
 ...
 'extras': 'a drop of blood, a piece of flesh, and a pinch of bone dust',
 'higher_levels': ' When you cast this spell using a spell slot of 4th level '
                  'or higher, you animate or reassert control over two '
                  'additional undead creatures for each slot level above 3rd. '
                  'Each of the creatures must come from a different corpse or '
                  'pile of bones.',
 'level': 3,
 'name': 'Animate Dead',
 'range': '10 feet',
